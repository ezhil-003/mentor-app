...
export function EventCalendar( { calendar } : EventCalendarProps ) {
  ...
  // /* ---------------------- Month Grid Calculation ---------------------- */
    ...
    const isPrevDisabled =
      startOfMonth(currentMonth) <= firstMonth
    
    const isNextDisabled =
      startOfMonth(currentMonth) >= lastMonth
    ...
    const handleRemove = useCallback((date: Date) => {
      setSelectedTrainingDayIds((prev) =>
          ...
          <div className="space-y-4">
            ...
            <div>
              <h3 className="mb-4 text-lg font-semibold">
                Selected Slots ({selectedDays.length})
              </h3>
                    ...
                    const dayData = calendarMap.get(dateKey)
                      ...
                      return (
                        ...
                        >
                          ...
                          <Button size="sm" variant="ghost" onClick={() => handleRemove(date)}>
                            Remove
                          </Button>
                        </div>
                      );
